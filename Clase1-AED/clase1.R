...
setwd("C:/Users/ASUS/Desktop/catedra_2023_2")
...
#Para seleccionar todos los estadísticos que requieras y agruparlos en una tabla
...
write.table(smy,"est_503.csv",row.names = F)
